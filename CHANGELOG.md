...
- Reject signed stream tokens that no longer resolve (expired, or the record is gone) instead of falling back to a public stream. Plain strings are still treated as public stream names.
